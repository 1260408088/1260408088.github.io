---
title: springCloud项目2
date: 2020-04-8 23:45:42
...
![1525532344817](1525532344817.png)
...
![1525568965976](1525568965976.png)
...
![1525569352313](1525569352313.png)
...
![1525570921966](1525570921966.png)
...
![1526877496885](1526877496885.png)
...
![1526877647406](1526877647406.png)
...
![1526877995530](1526877995530.png)
...
结果：
 ...
 ![1526877988488](1526877988488.png)
...
SpringCloud的版本命名比较特殊，因为它不是一个组件，而是许多组件的集合，它的命名是以A到Z的为首字母的一些单词组成：
 ...
 ![1525575903675](1525575903675.png)
...
![1525576816916](1525576816916.png)

填写项目信息：

 ![1525576909381](1525576909381.png)

添加web依赖：

![1525576950842](1525576950842.png)

添加mybatis依赖：

![1525576999052](1525576999052.png)

填写项目位置：

![1525577029150](1525577029150.png)

生成的项目结构：

 ![1525577106711](1525577106711.png)
...
项目结构：
 ...
 ![1525577911331](1525577911331.png)

### 5.1.3.启动并测试：

启动项目，访问接口：http://localhost:8081/user/7

 ![1525593139364](1525593139364.png)
...
因为我们没有配置端口，那么默认就是8080，我们访问：http://localhost:8080/consume?ids=6,7,8
 ...
 ![1525594222408](1525594222408.png)
...
![1525595012668](1525595012668.png)
...
![1525598231170](1525598231170.png)

选择依赖：

![1525598312368](1525598312368.png)
...
![1525605081129](1525605081129.png)
...
![1525609225152](1525609225152.png)
...
![1525613025086](1525613025086.png)

生成的URL：

![1525613051210](1525613051210.png)

访问结果：

 ![1525613160920](1525613160920.png)
...
注意：idea中一个应用不能启动两次，我们需要重新配置一个启动器：
 ...
 ![1525615070033](1525615070033.png)

 ![1525615095693](1525615095693.png)

![1525615026937](1525615026937.png)

然后启动即可。

3）启动测试：

![1525615165157](1525615165157.png)
...
![1525617060656](1525617060656.png)
...
![1525617542081](1525617542081.png)
...
首先我们启动两个user-service实例，一个8081，一个8082。
 ...
 ![1525619515586](1525619515586.png)

Eureka监控面板：

![1525619546904](1525619546904.png)
...
访问页面，查看结果：
 ...
 ![1525620305704](1525620305704.png)
...
结果：
 ...
 ![1525622357371](1525622357371.png)
...
它有以下实现：
 ...
 ![1525622876842](1525622876842.png)
...
再次测试，发现结果变成了随机：
 ...
 ![1525623193949](1525623193949.png)
...
我们现在关闭一个user-service实例：
 ...
 ![1525653565855](1525653565855.png)

因为服务剔除的延迟，consumer并不会立即得到最新的服务列表，此时再次访问你会得到错误提示：

![1525653715488](1525653715488.png)
...
我们重启user-consumer-demo，测试，发现即使user-service2宕机，也能通过另一台服务实例获取到结果！
 ...
 ![1525658269456](1525658269456.png)